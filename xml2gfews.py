...
# PARAMETERS
####################################################################################################### 
inputfilenm='Filters_strip_rnd1.xml'
#inputfilenm='Filters_strip.xml'
#inputfilenm='testing.xml'
regfilenm='Filters_strip.groovy'
helpfilenm='__TestingHelpers.groovy'
# INITIALS
####################################################################################################### 
